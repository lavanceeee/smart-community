<template>
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-200 transition-colors duration-300">
        <div class="max-w-[1500px] mx-auto px-4 py-4 flex items-start gap-4">
            ...
            <!-- Main Content -->
            <main class="flex-1 min-w-0 h-[calc(100vh-120px)]">
                <div class="h-full bg-white dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5 overflow-hidden flex">
                    ...
                    <div class="w-80 border-r border-slate-100 dark:border-slate-700/50 flex flex-col">
                        ...
                        <div class="p-4 border-b border-slate-100 dark:border-slate-700/50">
                            <div class="relative">
                                <Icon name="lucide:search" size="18" class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" />
                                <input
                                    v-model="searchQuery"
                                    type="text"
                                    placeholder="搜索好友..."
                                ...
                                >
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between mb-1">
                                            ...
                                            <!-- 未读消息数 -->
                                            <span 
                                                v-if="getUnreadCount(friend.friendUserId) > 0"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500 dark:text-slate-400">
                                            <span v-if="onlineStatus[currentFriend.friendUserId]" class="text-green-500">● 在线</span>
                            ...
                            <div ref="messageListRef" class="flex-1 overflow-y-auto p-6 space-y-4">
                                ...
                                <template v-else>
                                    ...
                                    >
                                        ...
                                        <div 
                                            class="max-w-[60%] px-4 py-2 rounded-2xl"
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span v-if="message.fromUserId === currentUserId && message.isRead === 1" class="ml-1">✓✓</span>
                                            </p>
                                        </div>
                                    </div>
                                </template>
