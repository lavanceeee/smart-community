<template>
  <div class="min-h-screen bg-[#f0f2f5] flex flex-col font-sans">
    <header
      class="w-full max-w-[1200px] mx-auto py-6 px-4 flex justify-between items-end"
    >
      <div class="flex items-end gap-4">
        <div
          class="text-[#ff5000] text-4xl font-extrabold tracking-tighter leading-none"
        >
      ...
      <div class="text-sm text-slate-500">
        已有账号？
        <NuxtLink to="/login" class="text-[#ff5000] font-bold hover:underline"
          >请登录</NuxtLink
        >
      </div>
    </header>
    ...
    <main class="flex-1 flex justify-center py-10">
      <div class="bg-white w-[800px] p-10 rounded-[12px] shadow-sm">
        <div class="flex justify-between mb-10 text-sm font-bold border-b pb-4">
          <span
            class="text-[#ff5000] border-b-2 border-[#ff5000] pb-4 -mb-4 px-2"
            >1. 设置用户信息</span
          >
        ...
        <form
          ...
          class="max-w-[500px] mx-auto space-y-6"
        >
          <div class="space-y-1">
          ...
          <div class="pt-2">
            <label class="flex items-start gap-2 cursor-pointer select-none">
              ...
              <span class="text-xs text-slate-500 leading-tight">
                我已阅读并同意
                <a href="#" class="text-[#ff5000]">《智慧社区平台服务协议》</a
                >、<a href="#" class="text-[#ff5000]">《隐私权政策》</a> 和
                <a href="#" class="text-[#ff5000]">《法律声明》</a
                >。我是中国公民并承诺填写真实信息。
              </span>
            </label>
          </div>
