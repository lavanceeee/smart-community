    ...
    <main class="flex-1 flex justify-center items-center pb-20">
      ...
      <div class="bg-white w-[950px] h-[500px] rounded-[20px] shadow-2xl shadow-slate-200/50 flex p-10 relative">
        ...
        <div class="flex-1 flex flex-col items-center justify-center border-r border-slate-100 pr-10">
          ...
          <div class="w-40 h-40 border border-slate-200 rounded-lg p-2 bg-white relative group cursor-pointer shadow-sm hover:shadow-md transition-all">
        ...
        <div class="flex-1 pl-10 flex flex-col justify-center">
          ...
          <div class="flex items-center gap-6 mb-8 text-lg">
            <button class="font-bold text-slate-800 border-b-2 border-transparent hover:text-[#ff5000]">密码登录</button>
            <button class="text-slate-500 hover:text-[#ff5000]">短信登录</button>
          </div>
          ...
          <form class="space-y-5" @submit.prevent>
            ...
            <div class="flex items-center gap-2 mt-4">
               ...
               <p class="text-xs text-slate-400 leading-tight">
                 已阅读并同意以下协议 <a href="#" class="text-slate-500 hover:text-[#ff5000]">淘宝平台服务协议</a>、<a href="#" class="text-slate-500 hover:text-[#ff5000]">隐私权政策</a>、<a href="#" class="text-slate-500 hover:text-[#ff5000]">法律声明</a>
               </p>
            </div>
          </form>
        </div>
