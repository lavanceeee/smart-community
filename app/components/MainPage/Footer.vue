<template>
  <footer
    class="bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 pt-10 pb-6 font-sans border-t border-slate-100 dark:border-slate-900 transition-colors duration-300">
