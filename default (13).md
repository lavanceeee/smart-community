...
**接口地址**:`/api/admin/visitor/{registerId}/audit`
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultVisitorRegisterResponse|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultPageVisitorRegisterResponse|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
...
**接口地址**:`/api/admin/visitor/batch-delete`
...
**接口地址**:`/api/admin/visitor/batch-audit`
...
**接口地址**:`/api/admin/visitor/{registerId}`
...
**接口地址**:`/api/admin/visitor/statistics`
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultVisitorStatisticsVO|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
...
|code|响应码|integer(int32)|integer(int32)|
|message|响应消息|string||
|data||VisitorStatisticsVO|VisitorStatisticsVO|
|&emsp;&emsp;totalCount|访客登记总数|integer(int64)||
|&emsp;&emsp;pendingCount|待审核数量|integer(int64)||
|&emsp;&emsp;approvedCount|已通过数量|integer(int64)||
|&emsp;&emsp;rejectedCount|已拒绝数量|integer(int64)||
|&emsp;&emsp;todayCount|今日新增登记数|integer(int64)||
|&emsp;&emsp;weekCount|本周新增登记数|integer(int64)||
|timestamp|时间戳|integer(int64)|integer(int64)|
...
**接口地址**:`/api/admin/parking/{spaceId}/audit`
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultParkingSpaceResponse|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
...
**接口地址**:`/api/admin/parking/batch-delete`
...
**接口地址**:`/api/admin/parking/batch-audit`
...
**接口地址**:`/api/admin/parking/{spaceId}`
...
**接口地址**:`/api/admin/parking/statistics`
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultParkingStatisticsVO|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
...
|code|响应码|integer(int32)|integer(int32)|
|message|响应消息|string||
|data||ParkingStatisticsVO|ParkingStatisticsVO|
|&emsp;&emsp;totalCount|车位登记总数|integer(int64)||
|&emsp;&emsp;pendingCount|待审核数量|integer(int64)||
|&emsp;&emsp;approvedCount|已通过数量|integer(int64)||
|&emsp;&emsp;rejectedCount|已拒绝数量|integer(int64)||
|&emsp;&emsp;todayCount|今日新增登记数|integer(int64)||
|&emsp;&emsp;weekCount|本周新增登记数|integer(int64)||
|&emsp;&emsp;boundCount|已绑定车位数|integer(int64)||
|timestamp|时间戳|integer(int64)|integer(int64)|
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|spaceNo|车位编号（模糊查询）|query|false|string||
|carNumber|车牌号（模糊查询）|query|false|string||
|pageNum|页码|query|false|integer(int32)||
|pageSize|每页大小|query|false|integer(int32)||
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultPageParkingSpaceResponse|
|400|Bad Request|ResultVoid|
|403|Forbidden|ResultVoid|
|404|Not Found||
|500|Internal Server Error|ResultVoid|
